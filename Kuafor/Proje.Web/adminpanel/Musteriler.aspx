<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Musteriler.aspx.cs" Inherits="Proje.Web.adminpanel.Musteriler" %>
...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic"/>
    <script type="text/javascript">
        function isDelete() {
            return confirm("Müşterinin bilgilerini randevu kaydı ile birlikte silmek istediğine emin misin?");
        }
        function isUpdate() {
            return confirm("Müşterinin kişisel bilgilerinde yaptığın değişiklikleri onaylıyor musun?");
        }
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Default.aspx"><i class="fa fa-circle-o"></i> Yönetim Paneli | 1</a></li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Musteriler.aspx"><i class="fa fa-circle-o"></i> Müşteri Tablosu</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">TÜM MÜŞTERİLERİN BİLGİLERİ</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="RandevuId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="100%" CssClass="table table-responsive table-striped" >
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:BoundField DataField="RandevuId" HeaderText="NO" InsertVisible="False" ReadOnly="True" SortExpression="RandevuId" />
                        <asp:BoundField DataField="MusteriAd" HeaderText="Müşteri Adı" SortExpression="MusteriAd" />
                        <asp:BoundField DataField="MusteriSoyad" HeaderText="Müşteri Soyad" SortExpression="MusteriSoyad" />
                        <asp:BoundField DataField="MusteriTelNo" HeaderText="Müşteri Telefon NO" SortExpression="MusteriTelNo" />
                        <asp:BoundField DataField="MusteriMail" HeaderText="Müşteri Mail Adresi" SortExpression="MusteriMail" />
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ErkekKuaforDBConnectionString %>" DeleteCommand="DELETE FROM [TBL_Randevu] WHERE [RandevuId] = @original_RandevuId AND (([MusteriAd] = @original_MusteriAd) OR ([MusteriAd] IS NULL AND @original_MusteriAd IS NULL)) AND (([MusteriSoyad] = @original_MusteriSoyad) OR ([MusteriSoyad] IS NULL AND @original_MusteriSoyad IS NULL)) AND (([MusteriTelNo] = @original_MusteriTelNo) OR ([MusteriTelNo] IS NULL AND @original_MusteriTelNo IS NULL)) AND (([MusteriMail] = @original_MusteriMail) OR ([MusteriMail] IS NULL AND @original_MusteriMail IS NULL))" InsertCommand="INSERT INTO [TBL_Randevu] ([MusteriAd], [MusteriSoyad], [MusteriTelNo], [MusteriMail]) VALUES (@MusteriAd, @MusteriSoyad, @MusteriTelNo, @MusteriMail)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [RandevuId], [MusteriAd], [MusteriSoyad], [MusteriTelNo], [MusteriMail] FROM [TBL_Randevu]" UpdateCommand="UPDATE [TBL_Randevu] SET [MusteriAd] = @MusteriAd, [MusteriSoyad] = @MusteriSoyad, [MusteriTelNo] = @MusteriTelNo, [MusteriMail] = @MusteriMail WHERE [RandevuId] = @original_RandevuId AND (([MusteriAd] = @original_MusteriAd) OR ([MusteriAd] IS NULL AND @original_MusteriAd IS NULL)) AND (([MusteriSoyad] = @original_MusteriSoyad) OR ([MusteriSoyad] IS NULL AND @original_MusteriSoyad IS NULL)) AND (([MusteriTelNo] = @original_MusteriTelNo) OR ([MusteriTelNo] IS NULL AND @original_MusteriTelNo IS NULL)) AND (([MusteriMail] = @original_MusteriMail) OR ([MusteriMail] IS NULL AND @original_MusteriMail IS NULL))">
                    <DeleteParameters>
                        <asp:Parameter Name="original_RandevuId" Type="Int32" />
                        <asp:Parameter Name="original_MusteriAd" Type="String" />
                        <asp:Parameter Name="original_MusteriSoyad" Type="String" />
                        <asp:Parameter Name="original_MusteriTelNo" Type="String" />
                        <asp:Parameter Name="original_MusteriMail" Type="String" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="MusteriAd" Type="String" />
                        <asp:Parameter Name="MusteriSoyad" Type="String" />
                        <asp:Parameter Name="MusteriTelNo" Type="String" />
                        <asp:Parameter Name="MusteriMail" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="MusteriAd" Type="String" />
                        <asp:Parameter Name="MusteriSoyad" Type="String" />
