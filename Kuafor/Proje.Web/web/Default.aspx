<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje.Web.web.Default" %>
					...
					<div class="overlay">
						<div class="container">
							<div class="main-banner-info">
								...
								<a href="hakkimizda.aspx" class="button-style mt-4 mr-2">Hakkımızda</a>
								<a href="RandevuAl.aspx" class="button-style mt-4">Randevu AL</a>
							</div>
						</div>
					</div>
				</div>
